...
```sh
tlmgr install latexmk babel babel-italian csvsimple hyphen-italian geometry newfile currfile graphics etoolbox fp l3kernel l3packages setspace hologo listings url xcolor pdfx hyperref libertine inconsolata newtx pgf pgfplots todonotes xkeyval tools oberdiek filehook greek-fontenc xmpincl
```
