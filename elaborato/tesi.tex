...
Questa architettura metodologica rappresenta la base teorica per un sistema di identificazione efficace ed efficiente, bilanciando precisione, prestazioni e manutenibilità, e costituisce il fondamento concettuale di \textit{Sensitive Data Detector}, descritto approfonditamente nel Capitolo~\refwithpage{chap:implementazione_tecnologie}.
...
\chapter{Implementazione e tecnologie di \textit{Sensitive Data Detector}}
