...
\begin{itemize}
    ...
    \item \textbf{Statistiche di accuratezza}: accuratezza complessiva, percentuali di veri positivi, veri negativi, falsi positivi e falsi negativi, percentuale di risposte corrette e di risposte errate, \textit{precision}, \textit{recall}
...
\begin{table}[h!]
    \centering
    \csvreader[
        tabular=|l|r|r|r|r|r|r|r|r|,
        table head=\hline \textbf{Modello} & \textbf{Righe} & \textbf{Tempo} & \textbf{TN} & \textbf{TP} & \textbf{FN} & \textbf{FP} & \textbf{\textit{Precision}} & \textbf{\textit{Recall}} \\ \hline,
        late after line=\\ \hline,
    ]{test_results_m1_v2.csv}{model=\model, righe=\righe, tempo=\tempo, tn=\tn, tp=\tp, fn=\fn, fp=\fp, precision=\precision, recall=\recall}
    {\model & \righe & \tempo & \tn\% & \tp\% & \fn\% & \fp\% & \precision\% & \recall\%}
...
\begin{table}[h!]
    ...
    \csvreader[
        ...
        table head=\hline \textbf{Modello} & \textbf{Righe} & \textbf{Tempo} & \textbf{TN} & \textbf{TP} & \textbf{FN} & \textbf{FP} & \textbf{\textit{Precision}} & \textbf{\textit{Recall}} \\ \hline,
        late after line=\\ \hline,
    ]{test_results_6950_v2.csv}{model=\model, righe=\righe, tempo=\tempo, tn=\tn, tp=\tp, fn=\fn, fp=\fp, precision=\precision, recall=\recall}
    {\model & \righe & \tempo & \tn\% & \tp\% & \fn\% & \fp\% & \precision\% & \recall\%}
